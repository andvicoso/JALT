...
public class RoverExecutorTest {
    ...
    private static Algorithm createAlgorithm() {
        ...
        PropositionsChooser chooser =
                new CombinatorBadRewardPropsChooser(new MeanRewardCombinator(), badRewardValue);
        ...
        return new ERGExecutor(pg, factory, chooser, maxIterations);//new Planner(pg, factory.createAgents(agents));//
    }
...
//        RandomProblemGenerator rpg = new RandomProblemGenerator(factory);
        ...
        return FileUtils.fromFile(
                "problems/RoverModel/problem9.emast");//rpg.run();
    }
