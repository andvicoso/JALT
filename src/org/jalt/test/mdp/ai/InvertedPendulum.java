...
public class InvertedPendulum {
	...
	public static void main(String[] args) {
		new InvertedPendulum().run(new InvertedPendulum(), null);
	}
	...
	public synchronized void updateState(int action) {
		...
		double angleDDot = (9.8 * sinangle - cosangle * common - fricPole * angleDot / poleMassLength)
