...
import org.jalt.model.algorithm.rl.archs.DynaQ;
import org.jalt.model.algorithm.rl.dp.ValueIteration;
import org.jalt.model.algorithm.rl.td.QLearning;
import org.jalt.model.problem.Problem;
import org.jalt.model.problem.ProblemFactory;
import org.jalt.model.solution.Policy;
import org.jalt.test.erg.AlgorithmTest;
import org.jalt.test.erg.ERGTest;
import org.jalt.test.erg.MultiERGTest;
import org.jalt.test.erg.antenna.AntennaExamples;
...
public class MainTest {
	...
	private static void runAntenna() throws IOException {
		...
		Map<String, Object> params = runVI(prob);
		...
		Test test = new BatchTest(probFactory, algTest.createAlgorithmFactory(), getDirResultPath(c, file));
		test.run(params);
	...
	private static void runBig() throws IOException {
		...
		AlgorithmTest algTest = new MultiERGTest(prob.getInitialStates().size(), c);
		// new AlgorithmTest(c);
	...
	private static void runMultiple() throws IOException {
		...
		for (final String file : ProblemsCLI.getAllFilesFromDir("GenericERGGridModel\\thesis\\1one")) {
			...
			Test test = new BatchTest(probFactory, algTest.createAlgorithmFactory(), getResultPath(c, file));
			test.run(params);
	...
	public static Map<String, Object> runVI(Problem prob) {
