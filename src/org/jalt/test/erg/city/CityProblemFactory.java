package org.jalt.test.erg.city;
...
public class CityProblemFactory extends ProblemFactory {
	...
	public CityProblemFactory(final int pRows, final int pCols, final int pAgents, final int pNumberOfObstacles, final int pNumberOfSemaphores,
	...
	protected Problem doCreate() {
		final CityModel model = new CityModel(rows, cols);
