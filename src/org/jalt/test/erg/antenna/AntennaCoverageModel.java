...
/**
 * Problem that represents a grid with propositions. The agent must find the path to exit up, avoid the obstacles and
 * keep itself inside an antenna coverage signal.
 * 
 * Grid Caption: 0-9: Initial agent x position h: hole s: stone w: water a: antenna c: antenna coverage u: exit up d:
 * exit down
 * 
 * @author andvicoso
 */
public class AntennaCoverageModel extends ERGGridModel {
	...
	public AntennaCoverageModel(final int pRows, final int pCols) {
		super(pRows, pCols);
		// set props
