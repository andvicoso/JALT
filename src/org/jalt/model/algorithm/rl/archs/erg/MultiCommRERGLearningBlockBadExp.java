...
public abstract class MultiCommRERGLearningBlockBadExp implements Algorithm<ERG, Policy>, MultiERGLearning {
	...
	public Policy run(Problem<ERG> prob, Map<String, Object> params) {
		...
		do {
			...
			for (ReinforcementLearning<ERG> learning : learnings) {
				...
				params.put(QTable.NAME + "_" + i, new ERGQTable(model.getStates(), model.getActions()));
	...
	protected Policy extractPolicyPPFERG(Map<String, Object> pParameters, Problem<ERG> pProb, ERG model, ERGQTable q) {
		Policy policy;
	...
	protected void runThread(final Problem<ERG> pProblem, final Map<String, Object> pParameters, final ReinforcementLearning<ERG> learning,
			final List<Policy> policies, final int agent) {
