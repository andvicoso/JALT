 ...
 * @author Anderson
 */
public class CommChangePreservAgentIterator<M extends ERG> extends ChangePreservGoalPropRepAgentIterator<M> {
    ...
    public CommChangePreservAgentIterator(int pAgent, double pMessageCost, double pBadRewardThreshold,
    ...
    public void messageReceived(final StateRewardMessage pMsg) {
        ...
        if (mustChangePreservationGoal(pMsg.getState())) {
            try {
                ...
                Logger.getLogger(CommChangePreservAgentIterator.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
