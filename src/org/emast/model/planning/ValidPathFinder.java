...
public class ValidPathFinder {
	...
	public static <M extends MDP> boolean exist(Problem<M> pProblem,
			PolicyGenerator<M> pPolicyGenerator, boolean pAcceptOne) {
		return exist(pProblem, pPolicyGenerator.run(pProblem, null), pAcceptOne);
	}
	...
	public static <M extends MDP> boolean exist(Problem<M> pProblem,
			PolicyGenerator<M> pPolicyGenerator, int pAgent) {
		Policy policy = pPolicyGenerator.run(pProblem, null);
